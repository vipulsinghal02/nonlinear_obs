...
\title{A Primer on Nonlinear Control with Applications in Synthetic Biology}
\author{Vipul Singhal}
\address{Integrated Biosciences, 900 Island Drive, Redwood City, CA 94065}
\email{vipul@integratedbiosciences.com}

\begin{abstract}
We present a comprehensive treatment of nonlinear observability and identifiability through differential geometry. Beginning with fundamental concepts (manifolds, Frobenius theorem, distributions and codistributions), we develop the theory of observability-identifiability codistribution. This leads to practical methods for identifying unobservable states and non-identifiable parameters in biological systems. Our focus throughout is on applications to synthetic biology and gene regulatory networks.
\end{abstract}
...
The terms $\frac{\partial y^j}{\partial x^i}$ form the {Jacobian} matrix, and as such, $F_*$ is also known as the \textit{differential} of $F$, denoted by $dF$. 
